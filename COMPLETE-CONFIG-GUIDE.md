...
| **`strict`** | All 92 rules set to `error` | CI enforcement — block on any issue |
...
### 1. ESLint 9+ (Recommended) - All 92 Rules
...
This enables all 92 rules with the correct severity (`error` or `warn`).
...
This enables all 92 rules. Swap `recommended` for any other config:
