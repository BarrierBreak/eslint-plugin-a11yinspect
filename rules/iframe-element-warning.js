module.exports = {
  meta: {
    type: "problem",
    docs: {
      description: "Accessibility warning checks for iframe elements",
      category: "Accessibility",
      recommended: true
    },
    messages: {
      iframeHidden: "⚠️ [Major] iframe is hidden (role=presentation/none or aria-hidden=true) (4.1.2 A)"
    },
    schema: []
  },
  create(context) {
    return {
      JSXOpeningElement(node) {
        ...
        if (isHidden) {
          context.report({ node, messageId: "iframeHidden" });
        }
      }
    };
  }
